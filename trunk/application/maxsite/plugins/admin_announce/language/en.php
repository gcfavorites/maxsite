...
$lang['Приблизительность максимальных и минимальных страниц.'] = 'Aproximately maximum(peak) and minimum views of pages.';
...
$lang['Наиболее просматриваемые страницы'] = 'Most viewed pages';
$lang['Наименее просматриваемые страницы'] = 'Least viewed pages';
$lang['Средне просматриваемые страницы'] = 'Average of pages views';
$lang['просмотров: '] = 'viewed: ';
$lang['редактировать'] = 'edit';
$lang['Статистика'] = 'Statistics';
$lang['Всего страниц: '] = 'Count of pages: ';
