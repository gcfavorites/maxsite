...
?>
<h1><?= t('Плагин FeedBurner', 'plugins') ?></h1>
<p class="info"><?= t('Плагин выполняет перенаправление вашего основного rss на сервис feedburner.com.', 'plugins') ?></p>

<?php
		$options = mso_get_option($options_key, 'plugins', array());
		if ( !isset($options['key']) ) $options['key'] = ''; 

		$form = '<p><strong>' . t('Адрес вашего фида в FeedBurner.com:', 'plugins') . '</strong></p>
