...
$par = array( 'limit'=>7, 'cut'=>'Читать полностью »', 'type'=>false ); 
...
<rss version="2.0">
	<channel>
		...
		<item>
			...
			<description><![CDATA[<?= $page_content . mso_page_comments_link($page_comment_allow, $page_slug, ' Обсудить', '', '', false) ?>]]></description>
		</item>
