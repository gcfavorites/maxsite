...
$lang['Слова для модерации'] = 'Wörte für Überprüfung';
...
'Geben Sie die Nummer des komuser an, deren Kommentare zur Überpfüfung gesendet werden. Ein Nummer pro Zeile. Achten Sie darauf, das diese Liste nur Überprüft wird, wenn die Prüfung der Schwarze Liste erfolgreich war.';
...
$lang['Укажите номера рубрик через запятую или пробел'] = 'Wählen Sie die Nummer einer Katagorie, trennen Sie mit Komma oder Leerzeichen';
...
$lang['Очистить форму'] = 'Fomular leeren';
...
$lang['название записи'] = 'Titel des Eintrages';
$lang['всего голосов'] = 'Gesammt Stimmen';
...
# sitemap
$lang['Воспользуйтесь картой сайта'] = 'Verwenden Sie die Sitemap';
...
# ushki
$lang['Ушки'] = 'Ohren';
$lang['Админ-доступ к Ушкам'] = 'Admin-Zugriff zu Ohren';
...
'Mit den Ohren können Sie beliegen HTML/PHP Code in Ihre Template einfügen, Widget oder andere Plugins. Ohren kann man leicht benutzen, z.B. zur Ausgabe von Zähler, Werbung Banner, etc. Erstellen Sie einfach ein Ohr und geben Sie Name in Widget oder mit Hilfe des Codes:';
...
$lang['Необходимо указать название ушки!'] = 'Sie müssen einen Namen für Ohr eingeben!';
$lang['Обновлено!'] = 'Aktualisiert!';
