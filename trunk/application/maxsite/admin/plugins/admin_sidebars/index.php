...
function admin_sidebars_admin_init($args = array()) 
{
	if ( mso_check_allow('admin_sidebars') ) 
	{
		...
		mso_admin_menu_add('options', $this_plugin_url, 'Сайдбары и виджеты', 7);
...
function admin_sidebars_admin($args = array()) 
{
	...
	mso_hook_add_dinamic( 'mso_admin_header', ' return $args . "Сайбдары и виджеты"; ' );
	mso_hook_add_dinamic( 'admin_title', ' return "Сайдбары и виджеты - " . $args; ' );
