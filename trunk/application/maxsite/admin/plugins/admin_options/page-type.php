...
<?php
	...
	// заголовки
	$CI->table->set_heading('ID', 'Тип', 'Описание', 'Действие');
	...
	$name = '<b>Новый тип</b><br /><input style="width: 99%;" type="text" name="f_new_name" value="">';
	$desc = '<b>Описание</b><br /><input style="width: 99%;" type="text" name="f_new_desc" value="">';
	$act = '<input type="submit" name="f_new_submit" value="&nbsp;Добавить новый тип&nbsp;">';
